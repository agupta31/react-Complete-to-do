...
},{"./lib/React":"C:\\Users\\akash\\Desktop\\reactExamples\\node_modules\\react\\lib\\React.js"}],"C:\\Users\\akash\\Desktop\\reactExamples\\src\\Button.jsx":[function(require,module,exports){
...
var Button=React.createClass({displayName: "Button",
     ...
     handleEdit:function(){
      ...
      render:function(){
           return(
               React.createElement("button", {className: "btn btn-"+(this.props.name==="delete"?"info":"danger"), onClick: this.props.name==='delete'?this.handleItems:this.handleEdit}, this.props.name)
             )
      }
});
          ...
          var listItems=this.props.listData.map(function(item){
                  return (
                      ...
                      React.createElement("li", null, item, 
                        React.createElement(Button, {dataItem: item, handleItemsEv: this.handleItemsEv, name: "delete"}), 
                      
                        React.createElement(Button, {name: "edit", handleEditItems: this.handleEditItemsEv, editData: item})
                       )
...
},{"./Button":"C:\\Users\\akash\\Desktop\\reactExamples\\src\\Button.jsx","react":"C:\\Users\\akash\\Desktop\\reactExamples\\node_modules\\react\\react.js"}],"C:\\Users\\akash\\Desktop\\reactExamples\\src\\ToDo.jsx":[function(require,module,exports){
var React=require("react");
       ...
       render:function(){
            return(
                React.createElement("div", {className: "container"}, 
                   React.createElement(List, {listData: this.data, inputValChange: this.changeText}), 
                   React.createElement("form", {onSubmit: this.handleSubmit}, 
                        React.createElement("input", {type: "text", value: this.state.newText, onChange: this.handleChange}), 
                        React.createElement("button", {className: "btn btn-primary"}, "Add")
                   ), 
                      React.createElement("button", {className: "btn btn-success", onClick: this.updateItemEv}, "update")
